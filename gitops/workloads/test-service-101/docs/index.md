...
Edit this file in `gitops/workloads/test-service-101/docs/index.md`, TechDocs
...
| --- | --- | --- |
| `CrashLoopBackOff` | Bad image tag or missing config | `kubectl logs -n preview-scaffold-test-service-101 -l app=test-service-101 --previous` |
...
- **Roll back**: revert the latest commit touching
  `gitops/workloads/test-service-101/`; ArgoCD reconciles within ~60s.
...
All three links are pre-filtered to the `preview-scaffold-test-service-101`
namespace via the URL variable. No regex, no fall-through to "All".

- [Grafana, pod metrics](http://localhost:3000/d/cluster-pods?var-namespace=preview-scaffold-test-service-101)
- [Grafana, service logs](http://localhost:3000/d/service-logs?var-namespace=preview-scaffold-test-service-101)
- [Grafana, error explorer](http://localhost:3000/d/error-explorer?var-namespace=preview-scaffold-test-service-101)
- [ArgoCD application](http://localhost:8080/applications/preview-scaffold-test-service-101)
